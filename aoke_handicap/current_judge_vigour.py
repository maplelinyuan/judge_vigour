...
try:
    ...
    livescore_table_tr_len = len(driver.find_elements_by_xpath('//div[@id="livescore_table"]/table/tbody/tr[@state="Not"]'))
    for table_tr_index in range(0, livescore_table_tr_len):
        cur_tr = driver.find_elements_by_xpath('//div[@id="livescore_table"]/table/tbody/tr[@state="Not"]')[table_tr_index]
        match_id = cur_tr.get_attribute('matchid')
        league_name = cur_tr.find_elements_by_xpath('td')[1].find_elements_by_xpath('a')[0].text
        match_time = cur_tr.find_elements_by_xpath('td')[2].text
        home_name = cur_tr.find_elements_by_xpath('td')[4].find_elements_by_xpath('a')[0].text
        away_name = cur_tr.find_elements_by_xpath('td')[6].find_elements_by_xpath('a')[0].text
